...
import static com.organicshop.constants.Messages.ROLE;

public class OrganicShopUserDetailsService implements UserDetailsService {

    private final UserRepository userRepository;

    public OrganicShopUserDetailsService(UserRepository userRepository) {
